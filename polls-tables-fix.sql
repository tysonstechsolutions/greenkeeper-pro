-- ==========================================
-- GreenKeeper Pro: Polls Tables FIX
-- Run this in Supabase SQL Editor
-- Drops and recreates all poll tables cleanly
-- ==========================================
...
-- Drop any leftover triggers/functions
DROP FUNCTION IF EXISTS update_poll_timestamp() CASCADE;
