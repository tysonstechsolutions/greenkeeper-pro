...
describe("IGE Based On / Other attachment", () => {
  // Tyson, 2026-09-22: "IGE Based On" is the pricing method ("Vendor Quote");
  // only the "Other" box carries the quote's filename.
  it("IGE Based On says Vendor Quote; Other carries the quote's filename", async () => {
    const { user } = await renderForm();
    ...
    expect(fieldControl("IGE Based On")).toHaveValue("Vendor Quote");
