...
function PageContent() {
  ...
  const handleDuplicate = async () => {
    ...
    if (duplicated) {
      router.push(`/plan/view?id=${duplicated.id}`);
    }
  };
  ...
  return (
    <div className="p-4 md:p-6 pb-24">
      ...
      {/* Header */}
      <DetailPageHeader
        backHref={goal.parent ? `/plan/view?id=${goal.parent.id}` : "/plan"}
          ...
          canEdit && (
            <div className="flex items-center gap-2">
              ...
              <DropdownMenu>
                ...
                <DropdownMenuContent align="end">
                  <DropdownMenuItem
                    onClick={() => router.push(`/plan/view?id=${goal.id}`)}
                  >
