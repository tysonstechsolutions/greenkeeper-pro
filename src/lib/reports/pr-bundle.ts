...
/**
 * Build a zip with PR + quote + 889. Missing pieces are skipped with a
 * warning rather than aborting — the user might not have a 889 on file
 * yet but still wants to download what they have.
 */
