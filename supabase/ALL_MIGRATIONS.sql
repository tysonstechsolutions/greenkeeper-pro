...
CREATE INDEX idx_course_zones_type ON course_zones(zone_type);
CREATE INDEX idx_course_zones_hole ON course_zones(hole_number);
...
CREATE INDEX idx_plan_goals_level ON plan_goals(plan_level);
CREATE INDEX idx_plan_goals_status ON plan_goals(status);
CREATE INDEX idx_plan_goals_year ON plan_goals(year);
CREATE INDEX idx_plan_goals_parent ON plan_goals(parent_goal_id);
...
CREATE INDEX idx_tasks_plan_goal ON tasks(plan_goal_id);
CREATE INDEX idx_tasks_parent ON tasks(parent_task_id);
CREATE INDEX idx_tasks_assigned_crew ON tasks(assigned_crew);
...
CREATE INDEX idx_photos_zone ON photos(zone_id);
...
CREATE INDEX idx_equipment_service_due ON equipment(next_service_due_date);
...
CREATE INDEX idx_equipment_logs_type ON equipment_logs(log_type);
CREATE INDEX idx_equipment_logs_date ON equipment_logs(created_at);
CREATE INDEX idx_equipment_logs_performed_by ON equipment_logs(performed_by);
...
CREATE INDEX idx_chemical_products_type ON chemical_products(product_type);
CREATE INDEX idx_chemical_products_active ON chemical_products(is_active);
CREATE INDEX idx_chemical_products_inventory ON chemical_products(current_inventory, reorder_threshold);
...
CREATE INDEX idx_chemical_applications_applied_by ON chemical_applications(applied_by);
CREATE INDEX idx_chemical_applications_rei ON chemical_applications(rei_expires_at) WHERE rei_expires_at IS NOT NULL;
...
CREATE INDEX idx_irrigation_zones_type ON irrigation_zones(zone_type);
CREATE INDEX idx_irrigation_zones_course_zone ON irrigation_zones(course_zone_id);
...
CREATE INDEX idx_irrigation_logs_zone ON irrigation_logs(irrigation_zone_id);
CREATE INDEX idx_irrigation_logs_date ON irrigation_logs(run_date);
CREATE INDEX idx_irrigation_logs_trigger ON irrigation_logs(trigger_type);
...
CREATE INDEX idx_weather_logs_frost ON weather_logs(frost_observed) WHERE frost_observed = true;
...
CREATE INDEX idx_budget_items_year ON budget_items(fiscal_year);
CREATE INDEX idx_budget_items_category ON budget_items(category);
CREATE INDEX idx_budget_items_month ON budget_items(fiscal_year, month);
...
CREATE INDEX idx_schedules_crew ON schedules(crew_assignment);
...
-- ════════════════════════════════════════════════════════════════
-- MIGRATION: 002_invites_table.sql
-- ════════════════════════════════════════════════════════════════
...
-- ════════════════════════════════════════════════════════════════
-- MIGRATION: 003_activity_log.sql
-- ════════════════════════════════════════════════════════════════
...
-- ════════════════════════════════════════════════════════════════
-- MIGRATION: 005_missing_tables.sql
-- ════════════════════════════════════════════════════════════════
...
-- ════════════════════════════════════════════════════════════════
-- MIGRATION: 006_add_director_role.sql
-- ════════════════════════════════════════════════════════════════
...
-- ════════════════════════════════════════════════════════════════
-- MIGRATION: 20260407_green_area_path.sql
-- ════════════════════════════════════════════════════════════════
...
-- ════════════════════════════════════════════════════════════════
-- MIGRATION: 20260407_green_observations.sql
-- ════════════════════════════════════════════════════════════════
...
-- ════════════════════════════════════════════════════════════════
-- MIGRATION: 20260407_hole_observations.sql
-- ════════════════════════════════════════════════════════════════
...
-- ════════════════════════════════════════════════════════════════
-- MIGRATION: 20260408_add_fix_instructions_to_hole_observations.sql
-- ════════════════════════════════════════════════════════════════
...
-- ════════════════════════════════════════════════════════════════
-- MIGRATION: 20260408_fix_equipment_inspections_rls.sql
-- ════════════════════════════════════════════════════════════════
...
-- ════════════════════════════════════════════════════════════════
-- MIGRATION: 20260408_observation_diagnosis_result.sql
-- ════════════════════════════════════════════════════════════════
...
-- ════════════════════════════════════════════════════════════════
-- MIGRATION: 20260409_add_equipment_parts_and_service_records.sql
-- ════════════════════════════════════════════════════════════════
...
-- ════════════════════════════════════════════════════════════════
-- MIGRATION: 20260409_add_order_items.sql
-- ════════════════════════════════════════════════════════════════
...
-- ════════════════════════════════════════════════════════════════
-- MIGRATION: 20260409_add_parking_lot_and_clubhouse_issues.sql
-- ════════════════════════════════════════════════════════════════
...
-- ════════════════════════════════════════════════════════════════
-- MIGRATION: 20260409_add_parts_delay_reason.sql
-- ════════════════════════════════════════════════════════════════
...
-- ════════════════════════════════════════════════════════════════
-- MIGRATION: 20260409_enable_rls_clubhouse_parkinglot.sql
-- ════════════════════════════════════════════════════════════════
...
-- ════════════════════════════════════════════════════════════════
-- MIGRATION: 20260409_enable_rls_equipment_tables.sql
-- ════════════════════════════════════════════════════════════════
...
-- ════════════════════════════════════════════════════════════════
-- MIGRATION: 20260411_add_chemical_compliance_fields.sql
-- ════════════════════════════════════════════════════════════════
...
-- ════════════════════════════════════════════════════════════════
-- MIGRATION: 20260411_add_drone_flights.sql
-- ════════════════════════════════════════════════════════════════
...
-- ════════════════════════════════════════════════════════════════
-- MIGRATION: 20260411_add_language_preference.sql
-- ════════════════════════════════════════════════════════════════
...
-- ════════════════════════════════════════════════════════════════
-- MIGRATION: 20260411_add_pin_positions.sql
-- ════════════════════════════════════════════════════════════════
...
-- ════════════════════════════════════════════════════════════════
-- MIGRATION: 20260411_add_push_subscriptions.sql
-- ════════════════════════════════════════════════════════════════
...
-- ════════════════════════════════════════════════════════════════
-- MIGRATION: 20260412_add_environmental_compliance.sql
-- ════════════════════════════════════════════════════════════════
...
-- ════════════════════════════════════════════════════════════════
-- MIGRATION: 20260412_add_inspection_checklists.sql
-- ════════════════════════════════════════════════════════════════
...
-- ════════════════════════════════════════════════════════════════
-- MIGRATION: 20260412_add_water_usage.sql
-- ════════════════════════════════════════════════════════════════
...
-- ════════════════════════════════════════════════════════════════
-- MIGRATION: 20260413_add_asset_disposals.sql
-- ════════════════════════════════════════════════════════════════
...
-- ════════════════════════════════════════════════════════════════
-- MIGRATION: 20260413_add_grub_damage_issue_type.sql
-- ════════════════════════════════════════════════════════════════
...
-- ════════════════════════════════════════════════════════════════
-- MIGRATION: 20260413_add_parking_lot_pin_coords_and_types.sql
-- ════════════════════════════════════════════════════════════════
...
-- ════════════════════════════════════════════════════════════════
-- MIGRATION: 20260413_fix_equipment_rls.sql
-- ════════════════════════════════════════════════════════════════
...
-- ════════════════════════════════════════════════════════════════
-- MIGRATION: 20260415_add_ai_conversations.sql
-- ════════════════════════════════════════════════════════════════
...
-- ════════════════════════════════════════════════════════════════
-- MIGRATION: 20260415_add_fy26_assets.sql
-- ════════════════════════════════════════════════════════════════
...
-- ════════════════════════════════════════════════════════════════
-- MIGRATION: 20260415_add_gm_tables.sql
-- ════════════════════════════════════════════════════════════════
...
-- ════════════════════════════════════════════════════════════════
-- MIGRATION: 20260415_add_irrigation.sql
-- ════════════════════════════════════════════════════════════════
...
-- ════════════════════════════════════════════════════════════════
-- MIGRATION: 20260415_add_tournaments.sql
-- ════════════════════════════════════════════════════════════════
...
-- ════════════════════════════════════════════════════════════════
-- MIGRATION: 20260415_add_vendors.sql
-- ════════════════════════════════════════════════════════════════
...
-- ════════════════════════════════════════════════════════════════
-- MIGRATION: 20260415_fix_photos_bucket.sql
-- ════════════════════════════════════════════════════════════════
...
-- ════════════════════════════════════════════════════════════════
-- MIGRATION: 20260416_add_asset_photos_and_damage.sql
-- ════════════════════════════════════════════════════════════════
...
-- ════════════════════════════════════════════════════════════════
-- MIGRATION: 20260416_add_manufacturer_service_fields.sql
-- ════════════════════════════════════════════════════════════════
